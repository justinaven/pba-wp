...
$(document).ready(function(){
	...
	/* Client Category Expand
	------------------------------------------ */

	$('.client-cat-block ul').css('display','none');

	$('.client-cat-block h3').on('click', function(e){
		var $this = $(this);
		if($this.closest('.client-cat-block').hasClass('expanded')){
			$this.closest('.expanded').toggleClass('expanded').find('ul').slideToggle('fast', function() {
			});
		} else {
			if($this.closest('.client-cat-block').siblings('.expanded').length>0) {
				$this.closest('.client-cat-block').siblings('.expanded').toggleClass('expanded').find('ul').slideToggle('fast', function() {
					$this.closest('.client-cat-block').toggleClass('expanded').find('ul').slideToggle('fast', function() {
					});
				});
			} else { 
				$this.closest('.client-cat-block').toggleClass('expanded').find('ul').slideToggle('fast', function() {
